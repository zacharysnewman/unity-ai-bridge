...
3. Copy each skill file from the package into the project:
   ...
   - `.claude/commands/install-unity-ai-bridge.md` → `<project-root>/.claude/commands/install-unity-ai-bridge.md`
...
4. Handle `<project-root>/CLAUDE.md`:
   ...
   - If it already exists and already contains a `# Unity AI Bridge` heading: skip (already installed).
